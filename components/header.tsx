        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
                    ...
                    <div className="py-6 border-b">
                      <Link href="/" className="flex items-center gap-2">
                        <div className="relative h-10 w-10">
                          <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-600 to-red-600 shadow-lg"></div>
              ...
              <Link href="/" className="flex items-center gap-2">
                <div className="relative h-10 w-10">
                  <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-600 to-red-600 shadow-lg animate-pulse"></div>
                  <div className="absolute inset-[2px] rounded-full bg-white flex items-center justify-center">
                    <div className="h-4 w-4 rounded-full bg-gradient-to-br from-red-500 to-blue-500"></div>
                  </div>
                </div>
            ...
            <div className="hidden md:flex items-center gap-6 text-sm">
              ...
              <Link href="/locations" className="font-medium hover:text-blue-600 transition-colors">
                Locations
              </Link>
              <Link href="#" className="font-medium hover:text-blue-600 transition-colors">
                Categories
            ...
            <div className="hidden md:flex items-center relative">
              <div className="relative w-[500px]">
                <Input
                  ...
                  className="pl-10 pr-12 py-6 rounded-full border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-all"
                />
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                <Button className="absolute right-1 top-1/2 transform -translate-y-1/2 rounded-full h-9 bg-blue-600 hover:bg-blue-700">
                  Search
                </Button>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" className="relative hidden md:flex">
                ...
                <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center bg-red-600 text-white">
                  5
                </Badge>
              </Button>
              ...
              <Button className="hidden md:flex bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white">
                Sign In
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
              <Link href="#" className="text-sm font-medium text-red-600 flex items-center gap-1 hover:underline">
                Today&rsquo;s Deals
              </Link>
              <Link href="#" className="text-sm font-medium text-blue-600 flex items-center gap-1 hover:underline">
                Track Order
              </Link>
            </div>
          </div>
